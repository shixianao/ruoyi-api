...
CREATE TABLE `bpm_task_ext` (
  ...
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '审批建议',
...
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1222, '流程任务的更新', 1207, 2, '', '', 1, 0, 'F', '0', '0', 'bpm:task:update', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1221, '流程任务的查询', 1207, 1, '', '', 1, 0, 'F', '0', '0', 'bpm:task:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1220, '流程实例的取消', 1201, 3, '', '', 1, 0, 'F', '0', '0', 'bpm:process-instance:cancel', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1219, '流程实例的创建', 1201, 2, '', '', 1, 0, 'F', '0', '0', 'bpm:process-instance:create', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1218, '流程任务分配规则更新', 1193, 22, '', '', 1, 0, 'F', '0', '0', 'bpm:task-assign-rule:update', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1217, '流程任务分配规则创建', 1193, 21, '', '', 1, 0, 'F', '0', '0', 'bpm:task-assign-rule:create', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1216, '流程任务分配规则查询', 1193, 20, '', '', 1, 0, 'F', '0', '0', 'bpm:task-assign-rule:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1215, '流程定义查询', 1193, 10, '', '', 1, 0, 'F', '0', '0', 'bpm:process-definition:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1214, '用户组导出', 1209, 5, '', '', 1, 0, 'F', '0', '0', 'bpm:user-group:export', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1213, '用户组删除', 1209, 4, '', '', 1, 0, 'F', '0', '0', 'bpm:user-group:delete', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1212, '用户组更新', 1209, 3, '', '', 1, 0, 'F', '0', '0', 'bpm:user-group:update', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1211, '用户组创建', 1209, 2, '', '', 1, 0, 'F', '0', '0', 'bpm:user-group:create', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1210, '用户组查询', 1209, 1, '', '', 1, 0, 'F', '0', '0', 'bpm:user-group:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1209, '用户分组', 1186, 2, 'user-group', 'bpm/group/index', 1, 1, 'C', '0', '0', '', 'people', '', NULL, 'devAdmin', '2022-04-16 21:40:34', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1208, '已办任务', 1200, 20, 'done', 'bpm/task/done', 1, 1, 'C', '0', '0', '', 'eye', '', NULL, 'devAdmin', '2022-04-16 21:40:26', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1207, '待办任务', 1200, 10, 'todo', 'bpm/task/todo', 1, 1, 'C', '0', '0', '', 'eye-open', '', NULL, 'devAdmin', '2022-04-16 21:40:21', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1202, '流程实例的查询', 1201, 1, '', '', 1, 0, 'F', '0', '0', 'bpm:process-instance:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1201, '我的流程', 1200, 0, 'my', 'bpm/processInstance/index', 1, 1, 'C', '0', '0', '', 'people', '', NULL, 'devAdmin', '2022-04-16 21:40:17', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1200, '任务管理', 1185, 20, 'task', NULL, 1, 0, 'M', '0', '0', '', 'cascader', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1199, '模型发布', 1193, 6, '', '', 1, 0, 'F', '0', '0', 'bpm:model:deploy', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1198, '模型删除', 1193, 5, '', '', 1, 0, 'F', '0', '0', 'bpm:model:delete', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1197, '模型更新', 1193, 4, '', '', 1, 0, 'F', '0', '0', 'bpm:model:update', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1196, '模型导入', 1193, 3, '', '', 1, 0, 'F', '0', '0', 'bpm:model:import', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1195, '模型创建', 1193, 2, '', '', 1, 0, 'F', '0', '0', 'bpm:model:create', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1194, '模型查询', 1193, 1, '', '', 1, 0, 'F', '0', '0', 'bpm:model:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1193, '流程模型', 1186, 5, 'model', 'bpm/model/index', 1, 1, 'C', '0', '0', '', 'guide', '', NULL, 'devAdmin', '2022-04-16 21:40:31', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1192, '表单导出', 1187, 5, '', '', 1, 0, 'F', '0', '0', 'bpm:form:export', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1191, '表单删除', 1187, 4, '', '', 1, 0, 'F', '0', '0', 'bpm:form:delete', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1190, '表单更新', 1187, 3, '', '', 1, 0, 'F', '0', '0', 'bpm:form:update', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1189, '表单创建', 1187, 2, '', '', 1, 0, 'F', '0', '0', 'bpm:form:create', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1188, '表单查询', 1187, 1, '', '', 1, 0, 'F', '0', '0', 'bpm:form:query', '', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1187, '流程表单', 1186, 0, 'form', 'bpm/form/index', 1, 1, 'C', '0', '0', '', 'form', '', NULL, 'devAdmin', '2022-04-16 20:56:20', '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1186, '流程管理', 1185, 10, 'manager', NULL, 1, 0, 'M', '0', '0', '', 'nested', '', NULL, '', NULL, '');
INSERT INTO `sys_menu`(`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1185, '工作流程', 0, 50, '/bpm', NULL, 1, 0, 'M', '0', '0', '', 'tool', '', NULL, '', NULL, '');


INSERT INTO `sys_dict_type`
(`dict_id`, `dict_name`, `dict_type`, `status`, `remark`) VALUES 
(138, '流程分类', 'bpm_model_category', 0, '流程分类'),
(139, '流程实例的状态', 'bpm_process_instance_status', 0, '流程实例的状态'),
(140, '流程实例的结果', 'bpm_process_instance_result', 0, '流程实例的结果'),
(141, '流程的表单类型', 'bpm_model_form_type', 0, '流程的表单类型'),
(142, '任务分配规则的类型', 'bpm_task_assign_rule_type', 0, '任务分配规则的类型'),
(143, '任务分配自定义脚本', 'bpm_task_assign_script', 0, '任务分配自定义脚本');

INSERT INTO `sys_dict_data`(`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `status`, `list_class`, `css_class`, `remark`) VALUES
(1125, 0, '默认', '1', 'bpm_model_category', 0, 'primary', '', '流程分类 - 默认'),
(1126, 0, 'OA', '2', 'bpm_model_category', 0, 'success', '', '流程分类 - OA'),
(1127, 0, '进行中', '1', 'bpm_process_instance_status', 0, 'primary', '', '流程实例的状态 - 进行中'),
(1128, 2, '已完成', '2', 'bpm_process_instance_status', 0, 'success', '', '流程实例的状态 - 已完成'),
(1129, 1, '处理中', '1', 'bpm_process_instance_result', 0, 'primary', '', '流程实例的结果 - 处理中'),
(1130, 2, '通过', '2', 'bpm_process_instance_result', 0, 'success', '', '流程实例的结果 - 通过'),
(1131, 3, '不通过', '3', 'bpm_process_instance_result', 0, 'danger', '', '流程实例的结果 - 不通过'),
(1132, 4, '已取消', '4', 'bpm_process_instance_result', 0, 'info', '', '流程实例的结果 - 撤销'),
(1133, 10, '流程表单', '10', 'bpm_model_form_type', 0, '', '', '流程的表单类型 - 流程表单'),
(1134, 20, '业务表单', '20', 'bpm_model_form_type', 0, '', '', '流程的表单类型 - 业务表单'),
(1135, 10, '角色', '10', 'bpm_task_assign_rule_type', 0, 'info', '', '任务分配规则的类型 - 角色'),
(1136, 20, '部门的成员', '20', 'bpm_task_assign_rule_type', 0, 'primary', '', '任务分配规则的类型 - 部门的成员'),
(1137, 21, '部门的负责人', '21', 'bpm_task_assign_rule_type', 0, 'primary', '', '任务分配规则的类型 - 部门的负责人'),
(1138, 30, '用户', '30', 'bpm_task_assign_rule_type', 0, 'info', '', '任务分配规则的类型 - 用户'),
(1139, 40, '用户组', '40', 'bpm_task_assign_rule_type', 0, 'warning', '', '任务分配规则的类型 - 用户组'),
(1140, 50, '自定义脚本', '50', 'bpm_task_assign_rule_type', 0, 'danger', '', '任务分配规则的类型 - 自定义脚本'),
(1141, 22, '岗位', '22', 'bpm_task_assign_rule_type', 0, 'success', '', '任务分配规则的类型 - 岗位'),
(1142, 10, '流程发起人', '10', 'bpm_task_assign_script', 0, '', '', '任务分配自定义脚本 - 流程发起人'),
(1143, 20, '流程发起人的一级领导', '20', 'bpm_task_assign_script', 0, '', '', '任务分配自定义脚本 - 流程发起人的一级领导'),
(1144, 21, '流程发起人的二级领导', '21', 'bpm_task_assign_script', 0, '', '', '任务分配自定义脚本 - 流程发起人的二级领导');
