...
CREATE TABLE test_demo (
	...
	`img` VARCHAR ( 255 ) NULL DEFAULT NULL COMMENT '头像',
	`status` CHAR ( 1 ) NOT NULL COMMENT '状态（0正常 1停用）',
	`birthday` datetime ( 0 ) NULL DEFAULT NULL COMMENT '出生日期',
	`sex` VARCHAR ( 255 ) NULL DEFAULT NULL COMMENT '性别',
	`love` VARCHAR ( 255 ) NULL DEFAULT NULL COMMENT '爱好',
	`attach_files` text NULL DEFAULT NULL COMMENT '附件',
	`info` text NULL DEFAULT NULL COMMENT '简介',
